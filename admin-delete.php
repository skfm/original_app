      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">ユーザー削除</a>
          </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">ユーザー削除</h4>
                  <p class="card-text">
                    下記のユーザーを削除しますか？<br>
                    削除する場合は削除ボタンをクリックしてください。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="submit" name="btn_submit" value="削除" class="btn btn-warning">
              <a class="btn_cancel btn btn-default" href="http://localhost/php/original_app/admin.php">戻る</a>
              </div>
              </form>
            </div>
          </div>
